...
femm = FEMMDeforLinear(material=m, fes=fes, integration_rule=GaussRule(dim=3, order=4))
...
vtkexport("LE11_H20_results", fes, geom, {"displacements": u, 'dT': dT, 'stresses': stresses})
