...
from spyfe.meshing.selection import fenode_select
...
start = time.time()
fens, feslist = abaqus_importer.import_mesh('LE11_H8_90deg.inp')
...
femm = FEMMDeforLinearH8MSGSO(material=m, fes=fes, integration_rule=GaussRule(dim=3, order=3))
...
vtkexport("LE11_H8_90deg_results", fes, geom, {"displacements": u, 'dT': dT, 'stresses': stresses})
